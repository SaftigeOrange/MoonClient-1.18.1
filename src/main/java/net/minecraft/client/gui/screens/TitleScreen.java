...
import de.orange.discord.RPC;
import de.orange.utils.Variables;
...
public class TitleScreen extends Screen
{
    ...
    public TitleScreen(boolean pFading)
    {
        ...
        RPC.instance().update("Main Menu", "Idling...", "home", "");
        this.fading = pFading;
    ...
    {
        return CompletableFuture.allOf(pTexMngr.preload(MINECRAFT_LOGO, pBackgroundExecutor), pTexMngr.preload(MINECRAFT_EDITION, pBackgroundExecutor));
    }
    ...
    public void render(PoseStack pPoseStack, int pMouseX, int pMouseY, float pPartialTick)
    {
        ...
        RenderSystem.setShaderTexture(0, BACKGROUND_PICTURE);
        ...
        if ((l & -67108864) != 0)
        {
            ...
            String s = "MoonClient " + SharedConstants.getCurrentVersion().getName();
