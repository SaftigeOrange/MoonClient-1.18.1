...
public class PauseScreen extends Screen
{
    ...
    private void createPauseMenu()
    {
        ...
        this.addRenderableWidget(new Button(this.width / 2 - 102, this.height / 4 + 120 - 16, 98, 20, new TextComponent("MoonClient Website"), (p_96323_) -> {
            this.minecraft.setScreen(new ConfirmLinkScreen((p_169338_) -> {
                if(p_169338_) {
                    Util.getPlatform().openUri(Client.websiteUrlMain);
                    this.minecraft.setScreen(this);
                } else
                    this.minecraft.setScreen(null);
            }, Client.websiteUrlMain, true));
        }));
        this.addRenderableWidget(new Button(this.width / 2 + 4, this.height / 4 + 120 - 16, 98, 20, new TextComponent("Discord Server"), (p_96113_) -> {
            this.minecraft.setScreen(new ConfirmLinkScreen((p_169836_) -> {
                if(p_169836_) {
                    Util.getPlatform().openUri(Client.websiteUrlDiscord);
                    this.minecraft.setScreen(this);
                } else
                    this.minecraft.setScreen(null);
            }, Client.websiteUrlDiscord, true));
        }));
